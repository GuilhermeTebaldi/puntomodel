        ...
        <div className="z-10 text-center lg:text-left">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <button
              ...
              className="bg-[#e3262e] text-white px-8 py-4 rounded-full font-bold text-sm md:text-base hover:bg-red-700 transition-colors shadow-lg shadow-red-200 uppercase tracking-wide"
            >
              {t('hero.cta')}
            </button>
          </div>
        ...
        <div className="relative z-10 flex justify-center lg:justify-end">
          <div className="relative w-full max-w-lg">
            ...
            <div className="relative">
              ...
              <img 
                src="https://i.pinimg.com/1200x/ca/22/78/ca2278b60a5b18b52060dc5d9d9f3a99.jpg" 
                alt={t('hero.imageAlt')} 
